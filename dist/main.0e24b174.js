...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"models/Movie.ts":[function(require,module,exports) {
"use strict";
...
exports.Movie = Movie;
;
},{}],"models/Service.ts":[function(require,module,exports) {
"use strict"; //syftet är att hämta data från vårt OMDB API 
...
/** @class */
function () {
  function Service() {} //här inne utvecklar vi funktionen och det som ska hända


  Service.prototype.getData = function () {
    return __awaiter(this, void 0, Promise, function () {
      var moviefetch, moviedata, movies;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , fetch("http://www.omdbapi.com/?apikey=65873bd2&s=Harry+Potter")];
